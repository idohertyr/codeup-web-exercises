(function () {
    ...
    var helloMessage = sayHello('Xavier');
...
// and stores it in a variable named random
    ...
    var total = prompt('How much is the total for the bill?');
    var tip = prompt('How much would you like to tip?');

    alert('Your tip dollar amount is ' + calculateTip(tip, total));
